...
public class DatabaseDiagnostics {
    ...
    private static final String URL =
            "jdbc:sqlserver://185.119.119.126:1433;databaseName=dijkstradb;encrypt=true;trustServerCertificate=true";
    private static final String USER = "dijkstra";
    private static final String PASSWORD = "dijkstra";
