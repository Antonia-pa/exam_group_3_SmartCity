...
public class ConnectionCheckLight {
    ...
    public static void checkDatabase() {
        ...
        String url = "jdbc:sqlserver://185.119.119.126:1433;databaseName=dijkstradb;encrypt=true;trustServerCertificate=true";
        String user = "dijkstra";
        String password = "dijkstra";
